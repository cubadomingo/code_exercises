...
describe('binarySearch', function() {
  ...
  it('uses a divide and conquer algorithm', function() {
    ...
    // proxyArray = array of 10000 numbers
    var proxyArray = generateRandomNumberArray(arrayLength);
    var smartArray = [];
    // iterate from 0 to 9999
    for (var i = 0; i < 10000; i++) {
      // pass the number to this function
      (function(i) {
        // when i is searched in smartArray send the number as a key and true
        // as the value to lookups
